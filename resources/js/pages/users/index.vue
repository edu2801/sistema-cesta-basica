                ...
                <v-data-table :headers="columns" :items="dataTable">
                    ...
                    <template v-slot:item.actions="{ item }">
                        ...
                        >
                            ...
                            <a
                                class="icons-table text-danger my-auto"
                    ...
                    >
                        <div class="modal-content tx-size-sm">
                            <div class="modal-body text-center p-4">
                                ...
                                <i
                                    class="fe fe-x-square fs-100 text-danger lh-1 mb-5 d-inline-block"
                                ></i>
                                <h4 class="text-danger tx-semibold">
                                    Você realmente deseja excluir?
                                </h4>
                                <p class="mg-b-20 mg-x-20">
                                    Ao prosseguir esse usuário será removido.
                                </p>
                                <button
...
export default {
    ...
    methods: {
        ...
        deleteItem() {
            axios
                .get("/users/delete/" + this.deleteId)
                .then((response) => {
